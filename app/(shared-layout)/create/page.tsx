        ...
        <div className="py-12">
            ...
            <Card className="w-full max-w-xl mx-auto">
                <CardHeader>
                    ...
                    <CardDescription>Create a new blog aritcle</CardDescription>
                </CardHeader>
                <CardContent>
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                        <FieldGroup className="gap-y-4">
                            ...
                            <Field>
                                ...
                                <Input aria-invalid={fieldState.invalid} placeholder="Please enter a title" {...field}/>
                                {fieldState.invalid && (
                            ...
                            <Field>
                                ...
                                <Textarea aria-invalid={fieldState.invalid} placeholder="Please enter your blog post" {...field}/>
                                {fieldState.invalid && (
                                    <FieldError errors={[fieldState.error]}/>
                                )}
                            </Field>
